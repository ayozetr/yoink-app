export const es = {
  ...
  settings: {
    ...
    shortcutGlobalPaste: "Pegar y analizar (global)",
    shortcutGlobalNote: "El atajo global solo funciona si lo activas en la sección Escritorio.",
    ...
    catSystem: "Escritorio",
    systemIntro: "Estas opciones solo aplican a la app de escritorio.",
    ...
    globalHotkey: "Atajo global (Ctrl+Shift+Y)",
    globalHotkeyHelp: "Trae Yoink al frente y analiza la URL del portapapeles desde cualquier aplicación.",
