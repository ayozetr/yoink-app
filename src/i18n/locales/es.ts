export const es = {
  ...
  preview: {
    ...
    trimInvalid: "Hora no válida — usa m:ss.",
    vrBadge: "VR",
    vr: "VR (inmersivo)",
    vrLayout: "Formato VR",
  ...
  panel: {
    ...
    loginHint:
      ...
      "Este contenido requiere iniciar sesión. Activa las cookies del navegador en Ajustes → Red y acceso — si ya lo hiciste, asegúrate de que ese navegador esté cerrado, o añade un archivo cookies.txt.",
  ...
  music: {
    ...
    import_one: "Importar {{count}} como audio",
    import_other: "Importar {{count}} como audio",
  ...
  autotag: {
    ...
    batchTitle_one: "Etiquetar {{count}} canción",
    batchTitle_other: "Etiquetar {{count}} canciones",
    applyMarked_one: "Aplicar a {{count}} marcada",
    applyMarked_other: "Aplicar a {{count}} marcadas",
  ...
  settings: {
    ...
    catGeneral: "General",
    catAbout: "Acerca de",
    catExtension: "Extensión",
    extensionIntro: "Agrega la extensión del navegador para enviar contenido a Yoink desde la propia web.",
    extensionGet: "Instalar",
    extensionManual: "O si lo prefieres, instálalo manualmente",
    extensionUsage: "Una vez instalado, basta con clic derecho en la web → Download with Yoink y el contenido será enviado a la app automáticamente para su descarga.",
    catShortcuts: "Atajos",
    shortcutFocusUrl: "Enfocar el campo de URL",
    shortcutSettings: "Abrir o cerrar Ajustes",
    shortcutPasteAnalyze: "Pegar un enlace y analizarlo",
    shortcutGlobalPaste: "Pegar y analizar",
    shortcutGlobalToggle: "Mostrar/ocultar Yoink",
    shortcutGlobalQuick: "Descarga rápida",
    shortcutGlobalFocusPaste: "Enfocar y pegar",
    shortcutGlobalCancel: "Cancelar descarga",
    shortcutGlobalFolder: "Abrir carpeta de descargas",
    shortcutsGlobal: "Globales",
    shortcutCloseModal: "Cerrar la ventana o el desplegable",
    shortcutsNote: "Las listas y menús también se manejan con ↑ ↓ y Enter.",
    secQuality: "Calidad",
    ...
    defaultContainer: "Formato de vídeo por defecto",
    defaultAudioFormat: "Formato de audio por defecto",
    defaultAudioFormatHint: "FLAC y WAV son para audio sin pérdida; la mayoría de sitios no ofrecen contenido compatible, por lo que en esos casos se usará MP3.",
    ...
    poTokenHelp:
      "Un token anónimo de 'prueba de que eres un cliente real' para YouTube — puede pasar el anti-bot sin cookies. 'Manual' usa el o los tokens que pegas; 'Auto' genera uno nuevo por vídeo localmente (y recurre al token que pegaste cuando no puede); 'Desactivado' no envía ninguno.",
    poTokenMode: "PO token (YouTube)",
    poTokenModeOff: "Desactivado",
    poTokenModeManual: "Token manual",
    poTokenModeAuto: "Auto (generar por vídeo)",
    poTokenModeAutoHint:
      "Genera un token nuevo para cada vídeo localmente en la app — sin configuración. Recurre a tu token manual cuando no está disponible (p. ej., la línea de comandos).",
    ...
    minimizeToTray: "Cerrar a la bandeja del sistema",
    minimizeToTrayHelp: "Al cerrar la ventana, Yoink se oculta en la bandeja del sistema en vez de salir. Usa el icono de la bandeja para volver a abrirlo o salir.",
    launchAtStartup: "Arrancar con el sistema",
    disableGlobalHotkeys: "Desactivar atajos globales",
    disableGlobalHotkeysHelp: "Los atajos globales reservan una combinación de todo el sistema (Ctrl+Shift+Y). Actívalo para desactivarlos si chocan con otra app.",
  ...
  whatsNew: {
    ...
    unavailable: "No se pudieron cargar las notas.",
    gotIt: "Entendido",
  },
  update: {
    available: "Yoink {{version}} disponible",
    backendMismatch: "Sigue corriendo un backend antiguo (v{{backend}}) — reinicia Yoink para completar la actualización a v{{app}}.",
    backendMismatchTitle: "Backend desactualizado",
    restart: "Reiniciar",
    action: "Actualizar",
    dismiss: "Descartar",
    notifyBody: "Ábrelo en Ajustes para instalar la actualización.",
    downloading: "Descargando actualización…",
    dontClose: "No cierres la app; se reiniciará sola.",
  },
  common: {
