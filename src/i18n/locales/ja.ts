export const ja = {
  ...
  music: {
    ...
    import_one: "{{count}} 曲を音声としてインポート",
    import_other: "{{count}} 曲を音声としてインポート",
  ...
  autotag: {
    ...
    cancel: "キャンセル",
    apply: "タグを適用",
    batchTitle_one: "{{count}} 曲にタグ付け",
    batchTitle_other: "{{count}} 曲にタグ付け",
    applyMarked_one: "選択した {{count}} 曲に適用",
    applyMarked_other: "選択した {{count}} 曲に適用",
  ...
  settings: {
    ...
    musicFolders: "音楽をアーティスト/アルバムのフォルダーに整理",
    musicFoldersHelp: "自動タグ付けした各トラックを <アーティスト>/<アルバム> フォルダー（Jellyfin/Plex/Navidrome のレイアウト）に移動します。.nfo が有効な場合、それらのフォルダーに album.nfo/artist.nfo も書き込みます。",
