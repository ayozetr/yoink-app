export const ja = {
  ...
  settings: {
    ...
    shortcutGlobalPaste: "貼り付けて解析（グローバル）",
    shortcutGlobalNote: "グローバルショートカットは「デスクトップ」セクションで有効にした場合のみ機能します。",
    ...
    catSystem: "デスクトップ",
    systemIntro: "これらのオプションはデスクトップアプリにのみ適用されます。",
    ...
    globalHotkey: "グローバルショートカット (Ctrl+Shift+Y)",
    globalHotkeyHelp: "どのアプリからでも Yoink を前面に表示し、クリップボードの URL を解析します。",
