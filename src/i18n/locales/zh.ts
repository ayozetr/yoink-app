export const zh = {
  ...
  settings: {
    ...
    shortcutGlobalPaste: "粘贴并分析（全局）",
    shortcutGlobalNote: "全局快捷键仅在您于桌面部分启用后才有效。",
