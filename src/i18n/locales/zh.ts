export const zh = {
  ...
  music: {
    ...
    import_one: "导入 {{count}} 首为音频",
    import_other: "导入 {{count}} 首为音频",
    download: "下载为音频",
    done: "已导入",
  ...
  autotag: {
    ...
    cancel: "取消",
    apply: "应用标签",
    batchTitle_one: "标记 {{count}} 首歌曲",
    batchTitle_other: "标记 {{count}} 首歌曲",
    applyMarked_one: "应用到已选的 {{count}} 首",
    applyMarked_other: "应用到已选的 {{count}} 首",
    includeTrack: "包含此曲目",
  },
  history: {
    clearConfirm: "确认？",
