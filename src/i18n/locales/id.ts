export const id = {
  ...
  music: {
    ...
    import_one: "Impor {{count}} sebagai audio",
    import_other: "Impor {{count}} sebagai audio",
  ...
  autotag: {
    ...
    cancel: "Batal",
    apply: "Terapkan tag",
    batchTitle_one: "Beri tag {{count}} lagu",
    batchTitle_other: "Beri tag {{count}} lagu",
    applyMarked_one: "Terapkan ke {{count}} yang dipilih",
    applyMarked_other: "Terapkan ke {{count}} yang dipilih",
  ...
  settings: {
    ...
    normalizeLufs: "Target kenyaringan",
