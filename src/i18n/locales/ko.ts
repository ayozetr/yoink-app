export const ko = {
  ...
  settings: {
    ...
    shortcutGlobalPaste: "붙여넣기 및 분석 (전역)",
    shortcutGlobalNote: "전역 단축키는 데스크톱 섹션에서 활성화해야 작동합니다.",
    ...
    catSystem: "데스크톱",
    systemIntro: "이 옵션은 데스크톱 앱에만 적용됩니다.",
    ...
    globalHotkey: "전역 단축키 (Ctrl+Shift+Y)",
    globalHotkeyHelp: "어떤 앱에서든 Yoink를 앞으로 가져와 클립보드의 URL을 분석합니다.",
