export const ko = {
  ...
  music: {
    ...
    import_one: "{{count}}개를 오디오로 가져오기",
    import_other: "{{count}}개를 오디오로 가져오기",
    download: "오디오로 다운로드",
    done: "가져옴",
  ...
  autotag: {
    ...
    cancel: "취소",
    apply: "태그 적용",
    batchTitle_one: "{{count}}곡 태그 지정",
    batchTitle_other: "{{count}}곡 태그 지정",
    applyMarked_one: "선택한 {{count}}개에 적용",
    applyMarked_other: "선택한 {{count}}개에 적용",
  ...
  settings: {
    ...
    catShortcuts: "단축키",
    shortcutFocusUrl: "URL 입력란으로 이동",
    shortcutSettings: "설정 열기/닫기",
    shortcutPasteAnalyze: "링크 붙여넣고 분석",
    shortcutGlobalPaste: "붙여넣기 및 분석",
    shortcutGlobalToggle: "Yoink 표시/숨기기",
    shortcutGlobalQuick: "빠른 다운로드",
    shortcutGlobalFocusPaste: "포커스 후 붙여넣기",
    shortcutGlobalCancel: "다운로드 취소",
    shortcutGlobalFolder: "다운로드 폴더 열기",
    shortcutsGlobal: "전역",
    shortcutCloseModal: "창이나 목록 닫기",
    shortcutsNote: "목록과 메뉴는 ↑ ↓ 와 Enter로도 조작할 수 있습니다.",
    secQuality: "품질",
    secProcessing: "처리",
    ...
    minimizeToTray: "시스템 트레이로 닫기",
    minimizeToTrayHelp: "창을 닫으면 Yoink가 종료되지 않고 시스템 트레이로 숨겨집니다. 트레이 아이콘으로 다시 열거나 종료할 수 있습니다.",
    launchAtStartup: "시스템 시작 시 실행",
    disableGlobalHotkeys: "전역 단축키 비활성화",
    disableGlobalHotkeysHelp: "전역 단축키는 시스템 전체 조합(Ctrl+Shift+Y)을 예약합니다. 다른 앱과 충돌하면 이 옵션을 켜서 비활성화하세요.",
