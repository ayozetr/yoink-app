export const en = {
  ...
  settings: {
    ...
    shortcutGlobalPaste: "Paste & analyze (global)",
    shortcutGlobalNote: "The global shortcut only works if you enable it in the Desktop section.",
    ...
    catSystem: "Desktop",
    systemIntro: "These options only apply to the desktop app.",
    ...
    globalHotkey: "Global shortcut (Ctrl+Shift+Y)",
    globalHotkeyHelp: "Brings Yoink to the front and analyzes the clipboard URL from any app.",
