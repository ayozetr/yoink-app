export const en = {
  ...
  backend: {
    unreachableTitle: "Can't reach the backend",
    unreachable:
      "Yoink can't reach its local backend. It may still be starting — retrying in the background.",
  },
  notify: {
  ...
  music: {
    ...
    import_one: "Import {{count}} as audio",
    import_other: "Import {{count}} as audio",
  ...
  autotag: {
    ...
    cancel: "Cancel",
    apply: "Apply tags",
    batchTitle_one: "Tag {{count}} song",
    batchTitle_other: "Tag {{count}} songs",
    applyMarked_one: "Apply to {{count}} selected",
    applyMarked_other: "Apply to {{count}} selected",
